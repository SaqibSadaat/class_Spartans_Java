...
public class ApplyFiltersToStringWithMethod {
        static String message = "Welcome TO TekSchool Java IS EASY! 123*&^^%^%%!@#)_!@#@#)!(*@$)(*!asdljhasdjklh";
//This problem was solved by different methods
        ...
        public static void main(String[] args) {
             ...
             // How to remove the spaces as well
